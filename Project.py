...
import requests
import json
bulk=input("Enter the name of city")
url=f"http://api.weatherapi.com/v1/current.json?key=1799ca067eca437699a61148232606&q={bulk}"
...
os.system(f"speaker.speak'the current weather in {bulk} is {w} degrees'")
